<template>
  <div class="multi-container">
    ...
    <div class="right-container">
      <div :class="['sub-container', {selected: selectedIndex === 0 }]" @click="subClick(0)">
        <div id="right1"></div>
        <img v-if="selectedIndex === 0 && cover" :src="cover"/>
      </div>
      <div :class="['sub-container', {selected: selectedIndex === 1 }]" @click="subClick(1)">
        <div id="right2"></div>
        <img v-if="selectedIndex === 1 && cover" :src="cover"/>
      </div>
      <div :class="['sub-container', {selected: selectedIndex === 2 }]"  @click="subClick(2)">
        <div id="right3"></div>
...
export default {
  ...
  methods: {
    ...
    createMainPlayer(index) { 
        ...
        this.mainPlayer.eventEmitter.on(EZUIKitPlayer.EVENTS.firstFrameDisplay, () => {
            setTimeout(() => {
    ...
    subClick(index) {
        ...
        this.players[this.selectedIndex] = this.createPlayer(this.list[this.selectedIndex])
